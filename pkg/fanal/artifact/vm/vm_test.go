...
func (t *testMockArtifactCache) PutBlob(blobID string, blobInfo types.BlobInfo) (err error) {
	for i, pkgInfo := range blobInfo.PackageInfos {
		for j := range pkgInfo.Packages {
			if !t.testInstalledFiles || j > 0 { // test first package only
	...
	}{
		{
			...
			putBlobExpectation: cache.ArtifactCachePutBlobExpectation{
				Args: cache.ArtifactCachePutBlobArgs{
					BlobID: "sha256:eb04c03ccbcd3a08142569a59adc85397010a4fc1127e916dfc27774f88b11d1",
			...
			putArtifactExpectations: []cache.ArtifactCachePutArtifactExpectation{
				{
					Args: cache.ArtifactCachePutArtifactArgs{
						ArtifactID: "sha256:eb04c03ccbcd3a08142569a59adc85397010a4fc1127e916dfc27774f88b11d1",
			...
			want: types.ArtifactReference{
				...
				ID:   "sha256:eb04c03ccbcd3a08142569a59adc85397010a4fc1127e916dfc27774f88b11d1",
				BlobIDs: []string{
					"sha256:eb04c03ccbcd3a08142569a59adc85397010a4fc1127e916dfc27774f88b11d1",
				},
			},
		},
		{
